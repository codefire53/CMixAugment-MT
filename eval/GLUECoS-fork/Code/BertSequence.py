...
def read_examples_from_file(data_dir, data_file, mode):
...
def train(args, train_dataset, valid_dataset, model, tokenizer, labels):
    ...
    for _ in train_iterator:
        ...
        results = evaluate(args, model, tokenizer, labels, args.val_data_file, 'validation')
...
def evaluate(args, model, tokenizer, labels, data_file, mode, prefix=""):

    eval_dataset = load_and_cache_examples(args, tokenizer, labels, data_file, mode=mode)
    ...
    # Evaluation
    logger.info("***** Running evaluation %s on %s*****", prefix, mode)
...
def load_and_cache_examples(args, tokenizer, labels, data_file, mode):

    logger.info("Creating features from dataset file at %s", args.data_dir)
    examples = read_examples_from_file(args.data_dir, data_file, mode)
...
def main():
    ...
    train_dataset = load_and_cache_examples(
        args, tokenizer, labels, args.train_data_file, mode="train")
    valid_dataset = load_and_cache_examples(
        args, tokenizer, labels, args.val_data_file, mode="validation")
    ...
    result = evaluate(args, model, tokenizer, labels, args.val_data_file, mode="validation")
    _ = evaluate(args, model, tokenizer, labels, args.test_data_file, mode="validation")
    preds = evaluate(args, model, tokenizer, labels, args.test_data_file, mode="test")
